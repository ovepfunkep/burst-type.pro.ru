...
const getLinks = (t: ReturnType<typeof useTranslations>): Link[] => [
	{
	...
	},
	{
		...
		label: `${t.footer.version} ${packageJSON.version}`,
		icon: (className: string) => (
			<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor" className={className}>
...
const Footer = (): React.ReactElement => {
	...
	return (
		<div className="fixed flex gap-4 justify-center bottom-0 w-full px-10 mb-5">
			<button className="flex gap-1 items-center text-sm text-neutral-400 dark:text-neutral-600 hover:text-neutral-800 dark:hover:text-neutral-200 tracking-tighter" type="button" onClick={handleToggleCredits}>
